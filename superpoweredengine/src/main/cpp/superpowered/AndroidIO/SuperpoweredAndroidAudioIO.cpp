...
// This is called periodically by the input audio queue. AudioContent input is received from the media server at this point.
...
// This is called periodically by the output audio queue. AudioContent for the user should be provided here.

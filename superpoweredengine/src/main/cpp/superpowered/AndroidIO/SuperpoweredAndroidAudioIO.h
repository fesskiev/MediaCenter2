...
/**
 ...
 If the application requires both audio input and audio output, this callback is called once (there is no separate audio input and audio output callback). AudioContent input is available in audioIO, and the application should change it's contents for audio output.
...
public:
/**
 @brief Creates an audio I/O instance. AudioContent input and/or output immediately starts after calling this.

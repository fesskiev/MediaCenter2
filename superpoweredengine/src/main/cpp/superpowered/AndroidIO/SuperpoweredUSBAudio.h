...
/**
 ...
 AudioContent input is available in audioIO, and the application should change it's contents for audio output.
...
/**
 ...
 Superpowered simplifies the unlimited possibilities of the USB AudioContent Class to a hierarchy with 3 levels:
 1. configuration
...
public:
    ...
    */
    ...
    /**
     @brief Gets the best input and output folderIndex for some audio parameters.
     
     @param deviceID Device identifier.
     @param inputIOindex Returns with the best input folderIndex.
     @param outputIOindex Returns with the best output folderIndex.
    ...
    /**
     ...
     @param IOindex The folderIndex of the input or output.
    ...
    /**
     ...
     @param deviceID Device identifier.
     @param pathIndex Path folderIndex.
    ...
    /*
     ...
     @param deviceID Device identifier.
     @param inputIOindex Input folderIndex.
     @param outputIOindex Output folderIndex.

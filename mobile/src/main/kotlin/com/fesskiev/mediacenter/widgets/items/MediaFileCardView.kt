...
class MediaFileCardView(context: Context, attrs: AttributeSet) : FrameLayout(context, attrs) {
    ...
    interface OnFileCardListener {
        ...
        fun onAnimateChanged(view: MediaFileCardView, open: Boolean)
    }
    ...
    private fun init(context: Context) {
        ...
        inflater.inflate(R.layout.layout_media_file_card_view, this, true)
